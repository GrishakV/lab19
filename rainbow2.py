...
l1 = Label(width=20)
e1 = Entry(width=20)
b1 = Button(width=3, bg="#ff0000")
b2 = Button(width=3, bg="#ff9900")
b3 = Button(width=3, bg="#ffff00")
b4 = Button(width=3, bg="#33cc33")
b5 = Button(width=3, bg="#6699ff")
b6 = Button(width=3, bg="#0000ff")
b7 = Button(width=3, bg="#cc00cc")
